...
本项目为中国科学技术大学 2026 春季学期徐伟、吴锋班《系统程序设计基础》课程在线文档，使用 Mkdocs 搭建并在 GitHub 上托管项目。
...
```
git clone https://github.com/USTC-ISO-2026/homepage.git
```
...
nav:
  - 首页: index.md
  - Lab1:
    - Lab1 简介: lab1/intro.md
    - Lab1 练习: lab1/tasks.md
    - Lab1 FAQ: lab1/FAQ.md
```
...
- `main`：主分支。包含全部的开发内容
- `gh-pages`：网页分支。这是部署在 `[github.io](https://ustc-isp-2026.github.io/homepage/)` 上的界面，包含不完全开发的实验教程。**每次实验的练习部分在实验发布时才放出。**
